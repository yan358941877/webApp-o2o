                ...
                <ReactSwipe className="carousel" swipeOptions={opt}>
                    <div className="carousel-item">
                        <ul className="clear-fix">
                            ...
                            <Link to="/search/jianshen"><li className="float-left jianshenyundong">健身运动</li></Link>
                            ...
                            <Link to="/search/zizhu"><li className="float-left zizhucan">自助餐</li></Link>
                    ...
                    <div className="carousel-item">
                        <ul className="clear-fix">
                            ...
                            <Link to="/search/yulexiuxian"><li className="float-left xuixianyule">休闲娱乐</li></Link>
                    ...
                    <div className="carousel-item">
                        <ul className="clear-fix">
                            ...
                            <Link to="/search/xuexi"><li className="float-left xuexipeixun">学习培训</li></Link>
